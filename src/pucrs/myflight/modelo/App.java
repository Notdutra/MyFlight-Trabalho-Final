...
public class App {
    ...
    public static void main(String[] args) {
         ...
         * gerCias.adicionar(new CiaAerea("TP", "TAP Portugal")); gerCias.adicionar(new
         * CiaAerea("AD", "Azul Linhas Aéreas"));
         */
        ...
        /*
         * gerAero.adicionar(new Aeroporto("POA", "Salgado Filho Intl", new
         * Geo(-29.9939, -51.1711))); gerAero.adicionar(new Aeroporto("GRU",
         * "São Paulo Guarulhos Intl", new Geo(-23.4356, -46.4731)));
         * gerAero.adicionar(new Aeroporto("LIS", "Lisbon", new Geo(38.7742, -9.1342)));
         * gerAero.adicionar(new Aeroporto("MIA", "Miami Intl Airport", new Geo(25.7933,
         * -80.2906))); gerAero.ordenarNomes();
         */
        ...
        System.out.println("Distância POA->GRU: " + Geo.distancia(poa.getLocal(), gru.getLocal()));

        System.out.println("Distâcia GRU->POA: " + gru.getLocal().distancia(poa.getLocal()));
        ...
        // Tarefa 2: mostrar a localização dos aeroportos que operam em determinado
        // período do dia
